        ...
        def draw_text(): 
            ...
            for row in range(0, self.rows + 1):
                for col in range(0, self.columns + 1):
                    ...
                    if self.pattern == "frame" or self.pattern == "frame":
        ...
        def draw_letters(row, col):
            ...
            if self.pattern == "frame":
                ...
                if(letters[row % len(letters)] == 'a'):
                    ...
                    text_string = f"{list(registry.lists['user.letter'][0].keys())[row%len(letters)]}" #gets the frame words currently being used
            ...
            # sees if the background schould be highlighted
                    ...
                    len(self.input_so_far) > 1 and self.input_so_far.endswith(letters[col % len(letters)])):
                #draw columns of frame words

                frame_word = list(registry.lists['user.letter'][0].keys())[col%len(letters)]
                letter_list = list(frame_word)
